...
const Skills = () => {
    return (
        <section id="skills" className="py-20 px-10 md:px-6 lg:px-8 bg-white">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mx-auto lg:max-w-5xl">
                    {skills.map(({ name, percentage, icon: SkillIcon, color }, index) => (
                        <div key={index} className="bg-white border-2 border-black p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow px-8">
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="flex flex-col ml-3 w-full ">
                                    ...
                                    <div className="relative bg-orange-500 h-2 rounded-full">
                                        <div className="absolute h-full rounded-full bg-black top-0 left-0 transition-all duration-1000"
